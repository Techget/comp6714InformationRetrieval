...
'''
able :  ['likely', 'unable', 'keen', 'free', 'willing', 'cluttered', 'frothy', 'imaginative', 'bloody', 'dumb']
average :  ['total', 'jobless', 'pectoral', 'dependent', 'incitement', 'worth', 'undeniable', 'stronger', 'humanitarian', 'imploded']
bad :  ['popular', 'subtle', 'sensible', 'compelling', 'great', 'cluttered', 'poor', 'peripheral', 'urban', 'unseen']
best :  ['highest', 'overall', 'passionate', 'horizontal', 'suitable', 'spectacular', 'hot', 'personal', 'torrential', 'biggest']
big :  ['german', 'large', 'apparent', 'thinner', 'automatic', 'massive', 'such', 'portable', 'equivalent', 'anglian']
certain :  ['unlimited', 'gutsy', 'exempt', 'accustomed', 'experimental', 'wide', 'unruly', 'happier', 'miserable', 'clearest']
common :  ['jumpy', 'qualitative', 'showbiz', 'residual', 'untaxed', 'turbulent', 'recordable', 'stronger', 'holy', 'compressed']
current :  ['new', 'clearer', 'likely', 'european', 'social', 'fourth', 'monetary', 'petty', 'traditional', 'downbeat']
different :  ['subdued', 'vacuous', 'clean', 'nazi', 'multiple', 'unsuitable', 'vulnerable', 'unbelievable', 'pirated', 'offensive']
difficult :  ['comfortable', 'bankrupt', 'disruptive', 'unjust', 'generic', 'sociable', 'unusual', 'unrealistic', 'upfront', 'onboard']
early :  ['ongoing', 'strong', 'official', 'shocking', 'complete', 'lawless', 'successive', 'playable', 'easy', 'nascent']
extra :  ['crippling', 'costly', 'social', 'wishful', 'readable', 'better', 'medical', 'equivalent', 'gifted', 'irreversible']
fair :  ['rare', 'agrarian', 'human', 'unlikely', 'necessary', 'preparatory', 'windy', 'sleaze', 'vacuous', 'american']
few :  ['putrid', 'diligent', 'factual', 'crossover', 'communist', 'incessant', 'satisfactory', 'consecutive', 'serial', 'exclusive']
final :  ['original', 'annual', 'quiet', 'significant', 'extraordinary', 'unspecified', 'overseen', 'wicked', 'fourth', 'purple']
former :  ['indefensible', 'fest', 'useful', 'ridiculous', 'public', 'counterfeit', 'supervisory', 'amputated', 'vocational', 'informed']
great :  ['good', 'nice', 'incredible', 'amazing', 'superb', 'technological', 'glad', 'huge', 'bad', 'pivotal']
hard :  ['excellent', 'idle', 'fabulous', 'intentional', 'utmost', 'unchanged', 'crippled', 'able', 'unsettled', 'holy']
high :  ['global', 'glorious', 'largest', 'healthy', 'brightest', 'low', 'flat', 'cheap', 'conducive', 'reminiscent']
huge :  ['dynamic', 'many', 'economic', 'natural', 'large', 'great', 'numerical', 'useful', 'weaker', 'inhumane']
important :  ['sized', 'benign', 'influential', 'fraudulent', 'innovative', 'necessary', 'concerned', 'uncomfortable', 'outdated', 'difficult']
key :  ['ethnic', 'unprofitable', 'muslim', 'single', 'troubled', 'essential', 'largest', 'biggest', 'peaceful', 'careful']
large :  ['small', 'slower', 'safer', 'huge', 'total', 'big', 'restrictive', 'communist', 'sectarian', 'terrestrial']
last :  ['little', 'costly', 'dishonest', 'exaggerated', 'scuffed', 'scientific', 'undemocratic', 'regressive', 'emotional', 'tolerable']
less :  ['bona', 'distressed', 'crippling', 'dull', 'invaluable', 'nots', 'adverse', 'jaded', 'gradual', 'extraordinary']
likely :  ['current', 'able', 'bilateral', 'stricter', 'necessary', 'multidimensional', 'long', 'quick', 'fragmented', 'recent']
little :  ['last', 'transitional', 'stellar', 'artistic', 'much', 'uncooperative', 'exhausted', 'comical', 'underused', 'real']
major :  ['concise', 'mandatory', 'vaunted', 'underwater', 'complex', 'rational', 'her', 'largest', 'stagnant', 'ingrown']
more :  ['outgoing', 'greener', 'biological', 'achievable', 'fabulous', 'confrontational', 'quiet', 'logistical', 'excessive', 'many']
most :  ['physical', 'structural', 'constant', 'continental', 'ineffective', 'zealous', 'lifelong', 'separate', 'unanimous', 'irrelevant']
much :  ['hapless', 'eerie', 'natural', 'cool', 'little', 'serial', 'nuts', 'abdominal', 'angry', 'beneficial']
new :  ['current', 'financial', 'frustrated', 'untaxed', 'substantial', 'anglian', 'unbundling', 'sore', 'big', 'budgetary']
next :  ['gigantic', 'routine', 'pink', 'militant', 'funny', 'last', 'synonymous', 'deft', 'stylish', 'richest']
old :  ['textual', 'alto', 'many', 'exotic', 'preliminary', 'fatal', 'impressive', 'prestigious', 'pointy', 'huge']
prime :  ['retaliatory', 'broader', 'collective', 'fried', 'ministerial', 'extraordinary', 'hardline', 'shropshire', 'significant', 'united']
real :  ['migrant', 'definitive', 'ignorant', 'peaceful', 'pacific', 'buoyant', 'extensive', 'little', 'secretive', 'stricter']
recent :  ['quieter', 'imminent', 'violent', 'ferocious', 'breakneck', 'flexible', 'likely', 'fewer', 'annual', 'unknown']
same :  ['ruthless', 'mixed', 'likeable', 'sour', 'cosmetic', 'gorgeous', 'prompt', 'green', 'jealous', 'charming']
serious :  ['outdated', 'convinced', 'whatever', 'third', 'ideological', 'murky', 'secret', 'bleakest', 'vague', 'nadal']
short :  ['inseparable', 'orderly', 'hefty', 'tedious', 'woeful', 'northern', 'wide', 'regulatory', 'unspecified', 'beloved']
small :  ['large', 'low', 'mixed', 'buoyant', 'current', 'competitve', 'readable', 'creative', 'unchanged', 'skilful']
top :  ['countless', 'toughest', 'troubled', 'defunct', 'impressionist', 'identical', 'unreleased', 'indelible', 'useless', 'logistical']
tough :  ['uncapped', 'convenient', 'actual', 'transitional', 'dependent', 'eady', 'impractical', 'wealthiest', 'draconian', 'adverse']
wide :  ['northern', 'dimmable', 'problematic', 'nicer', 'slightest', 'purple', 'particular', 'perverse', 'famous', 'panoramic']
'''
